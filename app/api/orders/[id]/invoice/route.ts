...
<head>
  ...
  <style>
    ...
    .total-row { font-weight: bold; font-size: 15px; background: #f5f5f5; }
...
<body>
  <div class="header">
    <div>
      <div class="brand">primebazaar<span>.</span></div>
      <div style="font-size:12px;color:#666;margin-top:4px">primebazaar.store</div>
    </div>
  ...
  <div class="footer">
    Thank you for shopping with Primebazaar! For questions, contact support@primebazaar.store
  </div>
</body>
</html>`
